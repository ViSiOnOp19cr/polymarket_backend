...
import { createMarket, updateMarket, getAllMarkets, ResolveMarket, LockBets, openMarket, getMarketById, getMarketsByCatagory, placeBet } from "../controllers/market.controller";
...
marketRoutes.post("/placebet/:id", userMiddlewares, placeBet);
